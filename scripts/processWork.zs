      ...
      if (combinedOutput.length == 4) {
        if (inputLiquidIsSingle) {
          mods.qmd.mass_spectrometer.addRecipe(
            inputIngr0, null,
            combinedOutput[0] * (min(combinedOutput[0].amount * 2, 64)),
            combinedOutput[1] * (min(combinedOutput[1].amount * 2, 64)),
            combinedOutput[2] * (min(combinedOutput[2].amount * 2, 64)),
            combinedOutput[3] * (min(combinedOutput[3].amount * 2, 64)),
            null, null, null, null, 2.0
          );
          mods.qmd.mass_spectrometer.addRecipe(
            inputIngr0, inputLiquids[0],
            combinedOutput[0] * (min(combinedOutput[0].amount * 1, 64)),
            combinedOutput[1] * (min(combinedOutput[1].amount * 6, 64)),
            combinedOutput[2] * (min(combinedOutput[2].amount * 6, 64)),
            combinedOutput[3] * (min(combinedOutput[3].amount * 6, 64)),
            null, null, null, null, 2.0
          );
        }
      }
